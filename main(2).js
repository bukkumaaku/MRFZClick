...
if (!files.exists("./明日方舟连点器/setting.js")) {
	files.create("./明日方舟连点器/setting.js");
	toast("配置文件丢失，已创建");
}

let setting = files.read("./明日方舟连点器/setting.js", (encoding = "utf-8"));
if (setting) {
...
var MaterialList = JSON.parse(
	files.read("./明日方舟连点器/materialName.json", (encoding = "utf-8"))
).material;
var MaterialMenu = MaterialList.join("|");
var AddItem,
	AddItemList = [],
	AddItemNum = 1;
var ImgPath = "file://./明日方舟连点器/res/material/";
ui.layout(
	<drawer id="drawer">
		<vertical>
			<appbar>
