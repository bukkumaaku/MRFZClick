...
function startClick() {
    ...
    while (Action) {
        ...
        let result3 = MRFZ.GetButton(capture, "DeepBlueActionStart");
        let result4 = MRFZ.GetButton(capture,"GoldenActionStart");
        if (result || result2 || result3 || result4) {
            ...
            MRFZ.ClickButton(result || result2 || result3 || result4);
            SleepTime = 3000;
            continue;
        }
